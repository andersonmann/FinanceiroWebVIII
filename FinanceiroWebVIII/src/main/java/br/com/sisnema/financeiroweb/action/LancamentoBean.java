...
public class LancamentoBean extends ActionBean<Lancamento> {
	...
	public List<LancamentoVO> getLista() {
		if (lista == null) {
			...
			lista = ((LancamentoRN) negocio).pesquisarListaPrincipal(obterContaAtiva(), mesPassado, null);
		}
		return lista;
	}
	...
	public List<LancamentoVO> getListaFuturos() {
		if (listaFuturos == null) {
			...
			listaFuturos = ((LancamentoRN) negocio).pesquisar(obterContaAtiva(), amanha, null);
		}
		return listaFuturos;
	}
